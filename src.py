...
def morph_hemi(data, src, morph='rh2lh', subjects_dir=None, has_subjects=True,
    ...
    return_stc : bool
        Also return the fsaverage_sym stc.
    ...
    # morph from subject to fsaverage_sym
    ...
    # morph hemispheres in fsaverage_sym
...
def select_vertices(src, hemi='both', selection='frontal', subjects_dir=None,
    ...
    if 'frontal' in selection:
        ...
        labels, labels_all = get_frontal_labels(subjects_dir=subjects_dir,
                                                subject=subject, hemi=hemi)
        labels_vert = find_label_vertices(src, labels)
...
def get_frontal_labels(subjects_dir=None, subject=None, parc='aparc',
                       hemi='both'):
    ...
    labels = dict()
    if parc == 'HCPMMP1':
        # these labels do not seem to be correct anymore...
    ...
    labels = [label for label in labels_all if label.name in labels]
